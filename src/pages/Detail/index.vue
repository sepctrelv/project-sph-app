<template>
  <div class="detail">
    ...
    <section class="con">
      ...
      <div class="conPoin">
        <span
          v-if="categoryView.category1Name"
          :data-category1-id="categoryView.category1Id"
          >{{ categoryView.category1Name }}</span
        >
        <span
          v-if="categoryView.category2Name"
          :data-category2-id="categoryView.category2Id"
          >{{ categoryView.category2Name }}</span
        >
        <span
          v-if="categoryView.category2Name"
          :data-category3-id="categoryView.category3Id"
